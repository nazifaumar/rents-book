        ...
        <div class="body-main h-100">
            <div class="row g-0 h-100">
                <div class="sidebar col-lg-2 collapse d-lg-block" id="openClose">
                    <br>
                    <a href="/dashIndex" @if (request()->Route()->uri == 'dashIndex') class="active" @endif><i
                            class="bi bi-house-fill p-2"></i>Dashboard</a>
                    <a href="/user" @if (request()->Route()->uri == 'user') class="active" @endif><i
                            class="bi bi-person-fill p-2"></i>User</a>
                    <a href="/book" @if (request()->Route()->uri == 'book') class="active" @endif><i
                            class="bi bi-book-fill p-2"></i>Books</a>
                    ...
                    <a href="rentLog" @if (request()->Route()->uri == 'rentLog') class="active" @endif><i
                            class="bi bi-bookmark-fill p-2"></i>Rents Logs</a>
                    <a href="/logout" @if (request()->Route()->uri == 'logout') class="active" @endif><i
                            class="bi bi-box-arrow-left p-2"></i>Logout</a>
                </div>
